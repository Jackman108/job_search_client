...
import SubscriptionUserTable from "@features/subscription/ui/user/SubscriptionUserTable/SubscriptionUserTable";
import {PaymentSuccess, PaymentError} from "@ui";
...
export const routes = [
    ...
    { path: '/subscription', element: <SubscriptionUserTable /> },
